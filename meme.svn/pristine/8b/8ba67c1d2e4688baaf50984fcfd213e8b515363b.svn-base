...
-- Dumping data for table laravel.particular_header: ~10 rows (approximately)
...
INSERT INTO `particular_header` (`id`, `project_id`, `particular_name`, `status`) VALUES
	(2, 2, 'SAMPLE PARTICULAR TITLE', 1),
	(3, 3, 'SAMPLE PARTICULAR TITLE', 1),
	(5, 5, 'SAMPLE PARTICULAR TITLE', 1),
	(6, 6, 'SAMPLE PARTICULAR TITLE', 1),
	(7, 7, 'SAMPLE PARTICULAR TITLE', 1),
	(8, 8, 'SAMPLE PARTICULAR TITLE', 1),
	(9, 9, 'SAMPLE PARTICULAR TITLE', 1),
	(10, 10, 'SAMPLE PARTICULAR TITLE', 1),
	(21, 11, 'hello world', 1),
	(22, 11, 'SAMPLE PARTICULAR TITLE 2', 1),
	(23, 11, 'SAMPLE PARTICULAR TITLE', 1),
	(24, 1, 'MY ORDER', 1),
	(25, 4, 'SAMPLE PARTICULAR TITLE', 1);
...
-- Dumping data for table laravel.particular_header_items: ~32 rows (approximately)
...
INSERT INTO `particular_header_items` (`id`, `particular_header_id`, `particular_name`, `unit`, `unit_label`, `unit_price`, `unit_subtotal`) VALUES
	...
	(70, 21, 'Sample Particular Name', 15, 'lot', 4.00, 60.00),
	(71, 21, 'Sample Particular Name', 17, 'sets', 3.00, 51.00),
	(72, 21, 'Sample Particular Name', 1, 'sqm', 2.00, 2.00),
	(73, 21, 'Sample Particular Name', 11, 'sqm', 1005.00, 11055.00),
	(74, 21, 'Sample Particular Name', 11, 'sqm', 1005.00, 11055.00),
	(75, 21, 'Sample Particular Name', 11, 'sqm', 513.00, 5643.00),
	(76, 21, 'Sample Particular Name', 1, 'sqm', 1013.00, 1013.00),
	(77, 21, 'Sample Particular Name', 1, 'sqm', 1031.00, 1031.00),
	(78, 22, 'Sample Particular Name', 13, 'lot', 13.00, 169.00),
	(79, 22, 'Sample Particular Name', 16, 'sqm', 20.00, 320.00),
	(80, 22, 'Sample Particular Name', 15, 'lot', 37.00, 555.00),
	(81, 22, 'Sample Particular Name', 20, 'sets', 15.00, 300.00),
	(82, 22, 'Sample Particular Name', 36, 'sqm', 35.00, 1260.00),
	(83, 23, 'Sample Particular Name', 4, 'sqm', 40.00, 160.00),
...
-- Dumping data for table laravel.projects: ~0 rows (approximately)
